...
from app import app
from app import db
from app.forms import EmptyForm, LoginForm, PostForm, RegistrationForm, EditProfileForm, ResetPasswordRequestForm, ResetPasswordForm
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Redirect logged user to original protected page
